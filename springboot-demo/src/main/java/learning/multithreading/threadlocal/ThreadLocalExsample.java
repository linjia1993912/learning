...
/**
 * @Description: Java中的ThreadLocal类允许我们创建只能被同一个线程读写的变量。
...
//            System.out.println("-------num-------" + num);
    ...
    public static void main(String[] args) {
        ...
        //得出结论
        //ThreadLocal 中 set 和 get 操作的都是对应线程的 table数组，
        // 因此在不同的线程中访问同一个 ThreadLocal 对象的 set 和 get 进行存取数据是不会相互干扰的
    }
}
